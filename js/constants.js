...
const EQ={
  ...
  eq_server_rack:{name:'Server rack (víc strojů)',cost:110000,mCost:2200,eff:'quality',val:22,icon:'🗼',vCPU:16,ramGB:64,desc:'Rack plný 1U serverů — vyšší kvalita služeb a základní compute pro cloud.'},
  eq_server_blade:{name:'Blade šasi',cost:260000,mCost:4800,eff:'quality',val:35,icon:'🏗️',vCPU:48,ramGB:192,desc:'Blade servery: hustý výkon, sdílené napájení. Kvalita i slušný compute.'},
  ...
  eq_storage_rack:{name:'Storage rack (200 TB)',cost:480000,mCost:9500,eff:'storage',val:150,icon:'🗃️',storageTB:200,desc:'Hustý NVMe rack. Pro velké object storage nabídky.'},
  eq_storage_pod:{name:'Storage pod (1 PB)',cost:1650000,mCost:29000,eff:'storage',val:220,icon:'🧊',storageTB:1000,desc:'Petabajtový úložný pod — JBODy po stovkách disků, erasure coding.'},
  eq_storage_lake:{name:'Datové jezero (4 PB)',cost:5400000,mCost:85000,eff:'storage',val:300,icon:'🌊',storageTB:4000,desc:'Multi-PB škála pro archivy, zálohy a AI datasety. Vyžaduje pořádné DC.'},
  ...
  eq_cloudnode_ultra:{name:'Cloud superpod',cost:920000,mCost:21000,eff:'cloud',val:0,icon:'⚡',vCPU:512,ramGB:2048,desc:'512 vCPU / 2 TB RAM v jednom podu — základ pro dynamické (autoscaling) služby.'},
...
const CLOUD_PRICING={
  ...
  vps_dynamic:{name:'Dynamické VPS (autoscaling)',vCPU:2,ramGB:4,storageTB:0.1,price:899,mCost:170,icon:'🌀',cat:'vps',bwMbps:30,dynamic:true,reqEq:['eq_cloudnode'],desc:'Škáluje podle poptávky — účtuje se podle skutečného vytížení cloudu (85–145 % základní ceny).'},
  vps_dynamic_pro:{name:'Dynamické VPS Pro',vCPU:8,ramGB:32,storageTB:0.5,price:3499,mCost:700,icon:'🌪️',cat:'vps',bwMbps:120,dynamic:true,reqEq:['eq_cloudnode_ultra'],desc:'Autoscaling s garantovaným burstem. Vyžaduje Cloud superpod.'},
  ...
  s3_100t:{name:'Object Storage 100TB',storageTB:100,price:18999,mCost:4100,icon:'🗂️',cat:'s3',bwMbps:250,reqEq:['eq_storage_rack'],desc:'Velkoobjemové S3 s množstevní slevou.'},
  s3_1pb:{name:'Object Storage 1PB',storageTB:1000,price:149999,mCost:34000,icon:'🧊',cat:'s3',bwMbps:800,reqEq:['eq_storage_pod'],desc:'Petabajtový tier pro média, vědu a AI datasety.'},
  cold_1pb:{name:'Cold Archive 1PB',storageTB:1000,price:44999,mCost:8500,icon:'❄️',cat:'s3',bwMbps:30,reqEq:['eq_storage_pod'],desc:'Ledový archiv — levný, pomalé čtení, dlouhodobé retence.'},
  ...
  storage_scale:{name:'Block NVMe 100TB',storageTB:100,price:9999,mCost:2300,icon:'🚛',cat:'block',bwMbps:250,reqEq:['eq_storage_rack'],desc:'Škálovaný block tier pro velké DB a virtualizaci.'},
  baas_50t:{name:'Backup as a Service 50TB',storageTB:50,price:5999,mCost:1300,icon:'🛟',cat:'block',bwMbps:60,reqEq:['eq_backup'],desc:'Spravované zálohy s retencí a testy obnovy.'},
...
const STAFF_T={
  ...
  install:{name:'Instalační tým',cost:42000,icon:'🪛',desc:'Automaticky připojuje nové budovy pevnou přípojkou (kabelem) tam, kam dosáhne DC',eff:'install'},
};
